...
| --- | --- | --- | --- | --- | --- | --- | --- |
| dsh-novel-writing | development (6/11) | 36 | 30 | 0 | 2 | G5 passed-with-conditions | — |
...
| **P1** | UX-024 | 待用户实机复验后确认（用户强刷页面：三分割线常驻 + 所有滚动条默认隐藏/悬停显 + 滑章节名不带正文 + 正文滚动条滚动中可见） | UX-023 | v0.4.0 | open | 🔄 待复验 |
